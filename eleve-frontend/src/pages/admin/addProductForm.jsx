...
export default function AddProductForm() {
  ...
  const autoGenerateDescription = async () => {
    ...
    const currentBrand = form.getFieldValue("brand") || "ELEVÉ";
    const currentBenefits = form.getFieldValue("benefits") || [];
    const currentSkinTypes = form.getFieldValue("skinTypes") || [];
            ...
            <Row gutter={16}>
              ...
              <Col span={24}>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-slate-100"><span className="text-red-500 mr-1">*</span>Detailed Description</span>
                  <Button 
                    type="dashed" 
